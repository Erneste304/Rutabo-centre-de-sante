...
namespace HospitalManagementSystem.Data.Services
{
    ...
    public class DatabaseSeeder : IDatabaseSeeder
    {
        ...
        private async Task SeedAppointments()
        {
            ...
            int p = patients.Count;
            int d = doctors.Count;

            var appointments = new List<Appointment>
            {
                new Appointment { AppointmentNumber = "APT-2024-001", PatientId = patients[0 % p].PatientId, DoctorId = doctors[0 % d].DoctorId, AppointmentDate = DateTime.Today, AppointmentTime = new TimeSpan(9, 0, 0), AppointmentType = "Consultation", Status = "Scheduled", Reason = "Chest pain follow-up", DurationMinutes = 30, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
                new Appointment { AppointmentNumber = "APT-2024-002", PatientId = patients[1 % p].PatientId, DoctorId = doctors[1 % d].DoctorId, AppointmentDate = DateTime.Today, AppointmentTime = new TimeSpan(10, 30, 0), AppointmentType = "Follow-up", Status = "Confirmed", Reason = "Headache and dizziness", DurationMinutes = 30, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
                new Appointment { AppointmentNumber = "APT-2024-003", PatientId = patients[2 % p].PatientId, DoctorId = doctors[0 % d].DoctorId, AppointmentDate = DateTime.Today, AppointmentTime = new TimeSpan(11, 0, 0), AppointmentType = "Routine Checkup", Status = "Completed", Reason = "Diabetes management", Diagnosis = "Blood sugar controlled", DurationMinutes = 45, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
                new Appointment { AppointmentNumber = "APT-2024-004", PatientId = patients[3 % p].PatientId, DoctorId = doctors[3 % d].DoctorId, AppointmentDate = DateTime.Today.AddDays(1), AppointmentTime = new TimeSpan(9, 0, 0), AppointmentType = "Consultation", Status = "Scheduled", Reason = "Asthma review", DurationMinutes = 30, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
                new Appointment { AppointmentNumber = "APT-2024-005", PatientId = patients[4 % p].PatientId, DoctorId = doctors[2 % d].DoctorId, AppointmentDate = DateTime.Today.AddDays(-1), AppointmentTime = new TimeSpan(14, 0, 0), AppointmentType = "Emergency", Status = "Completed", Reason = "Severe joint pain", Diagnosis = "Arthritis flare-up", DurationMinutes = 60, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
                new Appointment { AppointmentNumber = "APT-2024-006", PatientId = patients[5 % p].PatientId, DoctorId = doctors[1 % d].DoctorId, AppointmentDate = DateTime.Today.AddDays(2), AppointmentTime = new TimeSpan(15, 0, 0), AppointmentType = "Follow-up", Status = "Scheduled", Reason = "Migraine treatment review", DurationMinutes = 30, CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            };
